...
export interface ErgoNetwork {
   ...
   */
  getUnspentByErgoTreeTemplateHash(
    hash: HexString,
    paging: Paging
  ): Promise<ErgoBox[]>;
...
export class Explorer implements ErgoNetwork {
  ...
  async getUnspentByErgoTree(
    tree: ErgoTree,
    paging: Paging
  ): Promise<ErgoBox[]> {
    return this.backend
      .request<network.ErgoBox[]>({
  ...
  async getUnspentByErgoTreeTemplate(
  ...
  async getUnspentByErgoTreeTemplateHash(
    hash: HexString,
    paging: Paging
  ): Promise<ErgoBox[]> {
    return this.backend
