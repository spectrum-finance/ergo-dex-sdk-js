...
import {N2DexyAmmPoolsParser, N2TAmmPoolsParser, T2TAmmPoolsParser} from "../parsers/ammPoolsParser"
...
export function makeDexyPools(network: ErgoNetwork): Pools<AmmPool> {
  return makePools(network, new N2DexyAmmPoolsParser(), N2Dexy.poolBundle())
}
